...
@section('content')
    ...
    <div class="aa-input-container" id="aa-input-container">
        <input type="search" id="aa-search-input" class="aa-input-search" placeholder="Rechercher un album, un cosplayer ou une catégorie..." name="search" autocomplete="off" />
    ...
    <script>
        var client = algoliasearch('0JPH2CFGR5', '4e7a32c3a5cdaf7c7899c1e116392b05');
        var albums = client.initIndex('albums-production');
        var cosplayers = client.initIndex('cosplayers-production');
        var categories = client.initIndex('categories-staging');
