<div class="column is-2 is-sidebar-menu is-hidden-mobile">
    <aside class="menu">
        ...
        <ul class="menu-list">
            <li>
                <a href="{{ route('admin.dashboard') }}" {{ Request::is('admin/dashboard*') ? 'class=is-active' : '' }}>Dashboard</a>
            </li>
            @can('index', \App\Models\Album::class)
                <li>
                    <a href="{{ route('admin.albums.index') }}" {{ Request::is('admin/albums*') ? 'class=is-active' : '' }}>Albums</a>
                </li>
            @endcan
