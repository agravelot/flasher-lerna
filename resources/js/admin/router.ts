...
import CosplayersIndex from '../components/admin/CosplayersIndex.vue';
import CosplayersCreate from '../components/admin/CosplayersCreate.vue';
import CosplayersEdit from '../components/admin/CosplayersEdit.vue';
