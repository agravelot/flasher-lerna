...
const (
	AlbumService_Index_FullMethodName     = "/albums.v2.AlbumService/Index"
	AlbumService_GetBySlug_FullMethodName = "/albums.v2.AlbumService/GetBySlug"
	AlbumService_Create_FullMethodName    = "/albums.v2.AlbumService/Create"
	AlbumService_Update_FullMethodName    = "/albums.v2.AlbumService/Update"
	AlbumService_Delete_FullMethodName    = "/albums.v2.AlbumService/Delete"
)
...
var AlbumService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "albums.v2.AlbumService",
	...
	Metadata: "albums/v2/albums.proto",
}
