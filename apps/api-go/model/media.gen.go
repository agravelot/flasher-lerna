...
type Medium struct {
	...
	ModelType        string            `gorm:"column:model_type;type:character varying(255);not null" json:"model_type"`
	ModelID          int64             `gorm:"column:model_id;type:bigint;not null" json:"model_id"`
