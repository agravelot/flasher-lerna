...
func (cq *CategoryQuery) QueryAlbumCategories() *AlbumCategoryQuery {
	query := &AlbumCategoryQuery{config: cq.config}
...
func (cq *CategoryQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (cq *CategoryQuery) FirstIDX(ctx context.Context) int32 {
...
func (cq *CategoryQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (cq *CategoryQuery) OnlyIDX(ctx context.Context) int32 {
...
func (cq *CategoryQuery) IDs(ctx context.Context) ([]int32, error) {
	var ids []int32
...
func (cq *CategoryQuery) IDsX(ctx context.Context) []int32 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *CategoryQuery) Clone() *CategoryQuery {
	...
	return &CategoryQuery{
		...
		withAlbumCategories: cq.withAlbumCategories.Clone(),
...
func (cq *CategoryQuery) WithAlbumCategories(opts ...func(*AlbumCategoryQuery)) *CategoryQuery {
	query := &AlbumCategoryQuery{config: cq.config}
	for _, opt := range opts {
		opt(query)
	}
	cq.withAlbumCategories = query
	return cq
}
...
func (cq *CategoryQuery) sqlAll(ctx context.Context) ([]*Category, error) {
	...
	if query := cq.withAlbumCategories; query != nil {
		fks := make([]driver.Value, 0, len(nodes))
		nodeids := make(map[int32]*Category)
		for i := range nodes {
		...
		query.Where(predicate.AlbumCategory(func(s *sql.Selector) {
			s.Where(sql.InValues(category.AlbumCategoriesColumn, fks...))
		}))
