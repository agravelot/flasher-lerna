...
func (f AlbumCategoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AlbumCategoryMutation)
	if !ok {
...
// The AlbumCosplayerFunc type is an adapter to allow the use of ordinary
// function as AlbumCosplayer mutator.
type AlbumCosplayerFunc func(context.Context, *ent.AlbumCosplayerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AlbumCosplayerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AlbumCosplayerMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AlbumCosplayerMutation", m)
	}
	return f(ctx, mv)
}
...
// The CosplayerFunc type is an adapter to allow the use of ordinary
// function as Cosplayer mutator.
type CosplayerFunc func(context.Context, *ent.CosplayerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CosplayerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.CosplayerMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CosplayerMutation", m)
	}
	return f(ctx, mv)
}
