...
func newPost(db *gorm.DB) post {
	...
	_post.ALL = field.NewField(tableName, "*")
	...
	_post.SeoTitle = field.NewString(tableName, "seo_title")
	_post.Body = field.NewString(tableName, "body")
	_post.Active = field.NewString(tableName, "active")
	...
	_post.SsoID = field.NewString(tableName, "sso_id")
...
func (p *post) updateTableName(table string) *post {
	...
	p.Active = field.NewString(table, "active")
	p.UserID = field.NewString(table, "user_id")
	p.CreatedAt = field.NewTime(table, "created_at")
	p.UpdatedAt = field.NewTime(table, "updated_at")
	p.SsoID = field.NewString(table, "sso_id")
...
func (p postDo) Joins(field field.RelationField) *postDo {
	return p.withDO(p.DO.Joins(field))
}

func (p postDo) Preload(field field.RelationField) *postDo {
