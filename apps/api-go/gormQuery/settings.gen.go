...
func newSetting(db *gorm.DB) setting {
	...
	_setting.Title = field.NewString(tableName, "title")
	_setting.Description = field.NewString(tableName, "description")
...
func (s settingDo) Joins(field field.RelationField) *settingDo {
	return s.withDO(s.DO.Joins(field))
}

func (s settingDo) Preload(field field.RelationField) *settingDo {
