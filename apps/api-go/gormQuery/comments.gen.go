...
func newComment(db *gorm.DB) comment {
	...
	_comment.CommentableID = field.NewString(tableName, "commentable_id")
	_comment.CommentableType = field.NewString(tableName, "commentable_type")
	_comment.Body = field.NewString(tableName, "body")
	_comment.SsoID = field.NewString(tableName, "sso_id")
...
type comment struct {
	...
	UserID          field.String
	CommentableID   field.String
	CommentableType field.String
	Body            field.String
	SsoID           field.String
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.CommentableID = field.NewString(table, "commentable_id")
	c.CommentableType = field.NewString(table, "commentable_type")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["commentable_id"] = c.CommentableID
	c.fieldMap["commentable_type"] = c.CommentableType
...
func (c commentDo) Joins(field field.RelationField) *commentDo {
	return c.withDO(c.DO.Joins(field))
}

func (c commentDo) Preload(field field.RelationField) *commentDo {
