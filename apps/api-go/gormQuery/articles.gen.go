...
func newArticle(db *gorm.DB) article {
	...
	_article.PublishedAt = field.NewString(tableName, "published_at")
	_article.CreatedAt = field.NewString(tableName, "created_at")
	_article.UpdatedAt = field.NewString(tableName, "updated_at")
	_article.DeletedAt = field.NewString(tableName, "deleted_at")
...
func (a *article) updateTableName(table string) *article {
	...
	a.PublishedAt = field.NewString(table, "published_at")
