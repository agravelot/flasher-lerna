        ...
        >
            ...
            >
                        ...
                        <AnimatePresence initial={false} custom={direction}>
                            ...
                            >
                               <div className="relative">
                                  {!loaded && <svg className="absolute inset-1/2" width="38" height="38" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg">
                                      <defs>
                ...
                <div className="absolute inset-0 mx-auto flex items-center justify-center">
                    {/* Buttons */}
                    {loaded && (
                        <div className={"relative aspect-[3/2] max-h-screen w-full"}>
                            {navigation && (
                                <>
                                    {index > 0 && (
                                        <button
