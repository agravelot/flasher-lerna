...
# Stagging
    export SSH_PRIVATE_KEY=${CI_STAGGING_SSH_PRIVATE_KEY}
    export SSH_USER=${CI_STAGGING_SSH_USER}
    export CI_DEPLOY_SSH_PORT=${CI_STAGGING_DEPLOY_SSH_PORT}
    export CI_DEPLOY_URI=${CI_STAGGING_DEPLOY_URI}
    export APP_URL=${APP_URL_STAGGING}
    export APP_NAME=${APP_NAME_STAGGING}
    export APP_KEY=${APP_KEY_STAGGING}
fi
